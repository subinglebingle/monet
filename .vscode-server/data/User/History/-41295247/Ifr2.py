...
def run_training(monet, conf, trainloader):
    checkpoint_dir = './checkpoints' #여기랑 다음줄까지,,,,,,,,ㅜㅜ
    os.makedirs(os.path.dirname(conf.checkpoint_file), exist_ok=True)
...
#test하는 코드
def run_testing(monet, conf, testloader):
    # 모델 파라미터 로드
